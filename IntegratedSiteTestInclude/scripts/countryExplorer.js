...
centerCoords = {
    ...
    overviewLabels: {
        popBars: [.06, .065],
        landSquares: [.4, .83],
        degradedSquares: [.7, .83],
        crowdingSquares: [.06, .25],
        foodBar1: [.06, .83],
        foodBar2: [.16, .83],
        calories: [.4, .25],
        perCapita: [.7, .25]
...
function drawLandSquares(countryObject, graph){
    ...
    */
    ...
    landSquaresGroup
        ...
        .attr('y',function(e){
            return -11 + squareCentersY-landAreaScale(e.lu_agriculturalLand)
        })
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
    ...
    degradedSquareGroup
        .append('text')
        .attr('id','degraded-label')
        .attr('x',function(e){
            return 0;
        })
        .attr('y',function(e){
            return 12+ landAreaScale(e.lu_degradingArea);
        })
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
    ...
    wrap(d3.select('#degraded-label').text('test'), 'change in degraded land area between 1983 and 2003', 130);
...
function drawCrowdingSquares(countryCrowding, graph){
    ...
    if (countryTracker.view == "overview"){
        ...
        svg.append('text')
            ...
            .style('font-size', 12)
            .attr('class','crowdingunits-label')
            .attr('fill',typeCol)

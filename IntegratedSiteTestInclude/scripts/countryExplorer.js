...
centerCoords = {
    overview: {
        popBars: [.06, .13],
        landSquares: [.4, .93],
        degradedSquares: [.7, .92],  //note: these values are based on the default 450 px svg height; for the overview page, expands to 550 px
        crowdingSquares: [.06, .34],
        foodBar1: [.06, .92],
        foodBar2: [.21, .92],
        calories: [.4, .33],
        perCapita: [.7, .34]
...
function drawPopBars(dataIn,graph){
    ...
    popBars
        ...
        .text(function(e){return e.lu_totalPop.toLocaleString() + ' people'});//null);

    popBars
        .append('text')
        .attr('id','popbar-urban-label')
        .attr('x',function(e){
            return 0;
        })
        .attr('y',function(e){
    ...
    //wrap(d3.select('#popbar-urban-label').text('test'), 'urban population', 100);

    popBars
        .append('text')
        .attr('id','popbar-rural-label')
        .attr('x',function(e){
            return popLineScale(e.lu_urbanPop);
        })
        .attr('y',function(e){
            return 5+12;
        })
    ...
    popBars
        ...
        .on('mouseover', function(d){
            ...
            wrap(d3.select('#test-hover-text').text('test'), 'population bar test text', 100);*/
        });
...
function drawLandSquares(countryObject, graph){
    ...
    */
    ...
    landSquaresGroup
        ...
        .attr('fill','gray')
        .attr('background','white')
        .text(function(e){return e.lu_landArea.toLocaleString() + ' hectares (total)'});//null);

    landSquaresGroup
        .append('text')
        .attr('id','forest-label')
        .attr('x',function(e){
            return squareCentersX;
        })
        .attr('y',function(e){
            return squareCentersY-landAreaScale(e.lu_forestArea)
        })
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
    ...
    landSquaresGroup
        ...
        .attr('id','agric-label')
        .attr('x',function(e){
            return squareCentersX-landAreaScale(e.lu_agriculturalLand)
        })
        .attr('y',function(e){
            return squareCentersX-landAreaScale(e.lu_agriculturalLand)
        })
    ...
    landSquaresGroup
        .append('text')
        .attr('id','arable-label')
        .attr('x',function(e){
            return squareCentersX-landAreaScale(e.lu_arableLand)
        })
        .attr('y',function(e){
            return squareCentersY-landAreaScale(e.lu_arableLand)
        })
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
        .text('arable land');//null);
    ...
    landSquaresGroup
        ...
        .attr('id','other-label')
        .attr('x',function(e){
            return squareCentersX-landAreaScale(e.lu_otherLand)
        })
        .attr('y',function(e){
    ...
    landSquaresGroup
        ...
        .attr('id','urban-label')
        .attr('x',function(e){
            return squareCentersX-landAreaScale(e.lu_urbanLand);
        })
        .attr('y',function(e){
            return squareCentersY;
        })
    ...
    degradedSquareGroup
        ...
        .attr('background','white')
        .text(function(e){
            return e.lu_degradingArea.toLocaleString() + ' hectares, ' + 100*(e.lu_degradingArea/e.lu_landArea).toFixed(1)+ '%'
        });

    degradedSquareGroup
        .append('text')
        .attr('id','degradeddefn-label')
        .attr('x',function(e){
            return 0;
        })
        .attr('y',function(e){
            return 27+ landAreaScale(e.lu_degradingArea);
        })
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
    ...
    wrap(d3.select('#degradeddefn-label').text('test'), 'change in degraded land area between 1983 and 2003', 130);
...
function drawCrowdingSquares(countryCrowding, graph){
    ...
    if (countryTracker.view == "overview"){
        ...
        svg.append('text')
            .attr('x', width*centerCoords.overviewLabels.crowdingSquares[0])
            .attr('y', -7 + height*centerCoords.overviewLabels.crowdingSquares[1] + 25)
            .style('font-size', 12)
            .attr('id','crowdingunits-label')
            .attr('fill',typeCol)
            .text(Math.floor(countryCrowding[0].lu_peoplePerSqKm) + ' people per sq. km');
    }
    ...
    svg
        .append('text')
        .attr('id','crowding-label')
        .attr('x',width*centerCoords.overviewLabels.crowdingSquares[0])
        .attr('y',width*centerCoords.overviewLabels.crowdingSquares[1]+60)
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
    ...
    wrap(d3.select('#crowding-label').text('test'), 'box represents 1 sq. km (New York City is a little under 1000 sq. km)', 135);
...
function drawFoodBars(countryFoodBalance, graph){
    ...
    svg
        ...
        .attr('background','white')
        .attr('transform','translate(' + translateX1 + ',' + translateY1 + ')')
        .text("In: " +(countryFoodBalance[0].bal_importQuantity + countryFoodBalance[0].bal_produced).toLocaleString());


    //wrap(d3.select('#in-label').text('test'), (countryFoodBalance[0].bal_importQuantity + countryFoodBalance[0].bal_produced).toLocaleString() + ' tonnes in', 75);
    ...
    svg
        ...
        .text("Out: " +(countryFoodBalance[0].bal_exportQuantity + countryFoodBalance[0].bal_usedFood + countryFoodBalance[0].bal_usedNonFood + countryFoodBalance[0].bal_waste).toLocaleString());


    svg
        .append('text')
        .attr('id','imports-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(countryFoodBalance[0].bal_importQuantity))
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
    ...
    svg
        .append('text')
        .attr('id','produced-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(countryFoodBalance[0].bal_importQuantity) + foodBalanceScale(countryFoodBalance[0].bal_produced))
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
    ...
    svg
        .append('text')
        .attr('id','exports-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(countryFoodBalance[0].bal_exportQuantity))
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
    ...
    svg
        .append('text')
        .attr('id','usedfood-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(countryFoodBalance[0].bal_exportQuantity)+foodBalanceScale(countryFoodBalance[0].bal_usedFood))
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
    ...
    svg
        .append('text')
        .attr('id','usednonfood-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(countryFoodBalance[0].bal_exportQuantity)+foodBalanceScale(countryFoodBalance[0].bal_usedFood)+foodBalanceScale(countryFoodBalance[0].bal_usedNonFood))
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
    ...
    svg
        ...
        .attr('id','waste-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(countryFoodBalance[0].bal_exportQuantity)+foodBalanceScale(countryFoodBalance[0].bal_usedFood)+foodBalanceScale(countryFoodBalance[0].bal_usedNonFood)+foodBalanceScale(countryFoodBalance[0].bal_waste))
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
    ...
    //wrap(d3.select('#crowding-label').text('test'), 'box represents 1 sq. km (New York City is a little under 1000 sq. km)', 120);
...
function drawCalories(countryCalories, graph){
    ...
    svg
        ...
        .attr('background','white')
        .attr('transform','translate(' + translateX + ',' + translateY + ')')
        .text(countryCalories[0].pc_avgPerCapFoodSupply + ' calories per day');
...
function drawPCLandUse(landReqts){
    ...
    svg
        ...
        .attr('background','white')
        .attr('transform','translate(' + translateX + ',' + translateY + ')')
        .text(Math.floor(landReqts[0].pc_totalLandReq).toLocaleString() + ' hectares');

    svg
        .append('text')
        .attr('id','pcland-label')
        .attr('x',0)
        .attr('y',landAreaScale(landReqts[0].pc_totalLandReq)+12)
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
    ...
    svg
        .append('text')
        .attr('id','totalland-label')
        .attr('x',0)
        .attr('y',landAreaScale(landReqts[0].lu_landArea)+12)
        .style('text-anchor','begin')
        .attr('font-size',12)
        .attr('fill','gray')
        .attr('background','white')
...
function updateLandSquares(countryYearUpdate, graph){
    ...
    d3.selectAll('#landunit-label')
        ...
        .text(function(e){return countryYearUpdate[0].lu_landArea.toLocaleString() + ' hectares (total)'});//null);

    d3.selectAll('#forest-label')
        .attr('x',function(e){
            return squareCentersX;
        })
        .attr('y',function(e){
            return squareCentersY-landAreaScale(countryYearUpdate[0].lu_forestArea)
        });

    d3.selectAll('#agric-label')
        .attr('x',function(e){
            return squareCentersX-landAreaScale(countryYearUpdate[0].lu_agriculturalLand)
        })
        .attr('y',function(e){
            return squareCentersX-landAreaScale(countryYearUpdate[0].lu_agriculturalLand)
        });
    ...
    d3.selectAll('#arable-label')
        .attr('x',function(e){
            return squareCentersX-landAreaScale(countryYearUpdate[0].lu_arableLand)
        })
        .attr('y',function(e){
            return squareCentersY-landAreaScale(countryYearUpdate[0].lu_arableLand)
        });

    d3.selectAll('#other-label')
        .attr('x',function(e){
            return squareCentersX-landAreaScale(countryYearUpdate[0].lu_otherLand)
        })
        .attr('y',function(e){
            return squareCentersY;
        });

    d3.selectAll('#urban-label')
        .attr('x',function(e){
            return squareCentersX-landAreaScale(countryYearUpdate[0].lu_urbanLand);
        })
        .attr('y',function(e){
            return squareCentersY;
        });

    d3.selectAll('#degradedunits-label')
        .text(function(e){
            return countryYearUpdate[0].lu_degradingArea.toLocaleString() + ' hectares, ' + 100*(countryYearUpdate[0].lu_degradingArea/countryYearUpdate[0].lu_landArea).toFixed(1)+ '%'
        });

    d3.selectAll('#degradeddefn-label')
        .attr('x',function(e){
            return 0;
        })
        .attr('y',function(e){
            return 27+ landAreaScale(countryYearUpdate[0].lu_degradingArea);
        });
...
function updatePopBars(countryYearUpdate, graph){
    ...
    d3.selectAll('#popbar-urban-label')
        .data(countryYearUpdate)
        .attr('x',function(e){
            return 0;
        })
    ...
    d3.selectAll('#popbar-rural-label')
        .data(countryYearUpdate)
        .attr('x',function(e){
            return popLineScale(e.lu_urbanPop);
        })
...
function updateCrowdingSquares(countryYearUpdate, graph){
    ...
    d3.selectAll('#crowdingunits-label')
        .text(Math.floor(countryYearUpdate[0].lu_peoplePerSqKm) + ' people per sq. km');
...
function updateFoodBars(balanceUpdate, graph){
    ...
    d3.selectAll('#in-label')
        .text("In: " +(balanceUpdate[0].bal_importQuantity + balanceUpdate[0].bal_produced).toLocaleString());


    d3.selectAll('#out-label')
        .text("Out: " +(balanceUpdate[0].bal_exportQuantity + balanceUpdate[0].bal_usedFood + balanceUpdate[0].bal_usedNonFood + balanceUpdate[0].bal_waste).toLocaleString());


    d3.selectAll('#imports-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(balanceUpdate[0].bal_importQuantity));

    d3.selectAll('#produced-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(balanceUpdate[0].bal_importQuantity) + foodBalanceScale(balanceUpdate[0].bal_produced));

    d3.selectAll('#exports-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(balanceUpdate[0].bal_exportQuantity));

    d3.selectAll('#usedfood-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(balanceUpdate[0].bal_exportQuantity)+foodBalanceScale(balanceUpdate[0].bal_usedFood));

    d3.selectAll('#usednonfood-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(balanceUpdate[0].bal_exportQuantity)+foodBalanceScale(balanceUpdate[0].bal_usedFood)+foodBalanceScale(balanceUpdate[0].bal_usedNonFood))

    d3.selectAll('#waste-label')
        .attr('x',30)
        .attr('y',foodBalanceScale(balanceUpdate[0].bal_exportQuantity)+foodBalanceScale(balanceUpdate[0].bal_usedFood)+foodBalanceScale(balanceUpdate[0].bal_usedNonFood)+foodBalanceScale(balanceUpdate[0].bal_waste))
...
function updateCalories(pcLandUpdate, graph){
    ...
    d3.selectAll('#calories-label')
        .text(pcLandUpdate[0].pc_avgPerCapFoodSupply + ' calories per day');
...
function updateLandReqts(landReqts){
    ...
    d3.selectAll('#pclandunits-label')
        .text(Math.floor(landReqts[0].pc_totalLandReq).toLocaleString() + ' hectares');

    d3.selectAll('#pcland-label')
        .attr('x',0)
        .attr('y',landAreaScale(landReqts[0].pc_totalLandReq)+12);

    d3.selectAll('#totalland-label')
        .attr('x',0)
        .attr('y',landAreaScale(landReqts[0].lu_landArea)+12);
